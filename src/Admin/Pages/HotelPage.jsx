...
//         ...formData,
//         rating: 4.5,
//         image: formData.image || "/imgs/default-hotel.png",
//         features: [],
//         rooms: [],
//         reviews: [],
//       };
...
//           <form
//             onSubmit={handleHotelSubmit}
//             className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-8 space-y-1"
//           >
//             <input
//               type="text"
//               placeholder="Hotel Name *"
//               className="p-3 border border-gray-200 rounded-xl focus:ring-2 focus:ring-blue-500 block text-sm font-medium text-gray-700"
//               value={formData.name}
//               onChange={(e) =>
//                 setFormData({ ...formData, name: e.target.value })
//               }
...
//                   className="p-2 border border-gray-200 rounded-xl file:mr-4 file:py-2 file:px-4 file:rounded-lg file:border-0 file:text-sm file:font-semibold file:bg-blue-50 file:text-blue-700 hover:file:bg-blue-100"
//                 />
//                 {formData.image && (
//                   <img
//                     src={formData.image}
...
//                           type="file"
//                           accept="image/*"
//                           onChange={(e) => handleImageUpload(e, setRoomForm)}
//                           className="p-3 border border-gray-200 rounded-xl w-full"
//                         />
//                         {roomForm.image && (
//                           <img
//                             src={roomForm.image}
    ...
    >
      <div className="max-w-7xl mx-auto">
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8 mb-8">
          ...
          {/* Hotel Form with Responsive Grid */}
          <form
            onSubmit={handleHotelSubmit}
          ...
          >
            <div className="space-y-1">
              ...
              <input
                ...
                className="p-3 border border-gray-200 rounded-xl w-full focus:ring-2 focus:ring-blue-500"
                value={formData.name}
                onChange={(e) =>
                  setFormData({ ...formData, name: e.target.value })
                }
            ...
            <div className="space-y-1 md:col-span-2">
              ...
              <div className="flex flex-col gap-2">
                <input
                  ...
                  accept="image/*"
                  onChange={(e) => handleImageUpload(e, setFormData)}
                  className="p-2 border border-gray-200 rounded-xl file:mr-4 file:py-2 file:px-4 file:rounded-lg file:border-0 file:text-sm file:font-semibold file:bg-blue-50 file:text-blue-700 hover:file:bg-blue-100 w-full"
                />
                {formData.image && (
            ...
            <div className="space-y-1 md:col-span-3">
              ...
              <textarea
                placeholder="Luxurious resort with stunning ocean views..."
                className="p-3 border border-gray-200 rounded-xl w-full focus:ring-2 focus:ring-blue-500"
                value={formData.description}
                onChange={(e) =>
                  setFormData({ ...formData, description: e.target.value })
            ...
            <div className="md:col-span-3">
              <button
                type="submit"
                className="w-full bg-gradient-to-r from-green-600 to-blue-600 hover:from-green-700 hover:to-blue-700 text-white py-3 rounded-xl flex items-center justify-center gap-2 shadow-lg hover:shadow-xl transition-all"
              >
                <FiSave className="text-lg" />
                {editMode ? "Update Hotel" : "Add Hotel"}
              </button>
              ...
              >
                ...
                {selectedHotel?.id === hotel.id && (
                  ...
                  >
                    ...
                    {/* Room Form with Responsive Grid */}
                    <form
                      onSubmit={handleRoomSubmit}
                      className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 mb-8"
                    >
                      ...
                      <div className="space-y-1">
                        ...
                        <select
                          className="p-3 border border-gray-200 rounded-xl w-full bg-white"
                          value={roomForm.capacity}
                          onChange={(e) =>
                            setRoomForm({
                              ...roomForm,
                      ...
                      <div className="space-y-1 md:col-span-2">
                        ...
                        <input
                          type="text"
                          placeholder="Sea View, Jacuzzi, Mini Bar"
                          className="p-3 border border-gray-200 rounded-xl w-full"
                          value={roomForm.amenities}
                          onChange={(e) =>
                            setRoomForm({
                      ...
                      <div className="md:col-span-3 flex flex-col gap-2">
                        <button
                          type="submit"
                          className="bg-gradient-to-r from-purple-600 to-pink-600 hover:from-purple-700 hover:to-pink-700 text-white py-3 rounded-xl flex items-center justify-center gap-2 shadow-lg hover:shadow-xl transition-all"
                        >
                          <FiPlus />
                        ...
                        {editingRoomId && (
                          <button
                            ...
                            className="bg-gray-200 text-gray-700 py-3 rounded-xl flex items-center justify-center gap-2 shadow-lg hover:shadow-xl transition-all"
                          >
                            <FiX /> Cancel Edit
                          </button>
                        )}
