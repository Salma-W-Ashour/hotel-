...
const MyBookingsPage = () => {
  ...
  useEffect(() => {
    const loadBookings = () => {
      ...
      const validBookings = storedBookings.filter(
        (booking) => booking.hotelId && booking.checkIn && booking.checkOut
      );
      ...
      const bookingsWithDetails = validBookings.map((booking) => {
        ...
        return {
          ...
          hotelImage: hotel?.image || "/default-hotel.jpg",
          ...
          paymentMethod: booking.paymentMethod || "cash", // تم التعديل هنا
  ...
  const addBooking = (bookingData) => {
    ...
    const newBooking = {
      ...
      paymentMethod: bookingData.formData.paymentMethod || "cash",
...
//       const bookingsWithDetails = storedBookings
//         .filter((booking) => booking.hotelId) // استبعاد الحجوزات بدون hotelId
//         .map((booking) => {
//           const hotel = hotelsData.find((h) => h.id === booking.hotelId);

//           return {
//             ...booking,
//             id: booking.id || Date.now(), // إضافة ID إذا غير موجود
//             hotelName: hotel?.name || "N/A",
//             hotelPrice: hotel?.price || "N/A",
//             hotelImage: hotel?.image || "/default-hotel.jpg",
//             checkIn: booking.checkIn ? new Date(booking.checkIn) : null,
